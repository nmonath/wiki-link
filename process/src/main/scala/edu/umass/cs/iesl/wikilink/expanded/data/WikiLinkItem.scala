...
object WikiLinkItem extends ThriftStructCodec[WikiLinkItem] {
  ...
  override def encoder: (WikiLinkItem, TProtocol) => Unit = (w: WikiLinkItem,t:TProtocol) => encode(w,t)

  @scala.deprecated("your code is generated by an outdated version of scrooge-generator")
  override def decoder: (TProtocol) => WikiLinkItem = (t:TProtocol) => decode(t)

  override def encode(_item: WikiLinkItem, _oproto: TProtocol) { _item.write(_oproto) }
