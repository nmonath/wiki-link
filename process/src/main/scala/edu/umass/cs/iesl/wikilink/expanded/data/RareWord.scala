...
object RareWord extends ThriftStructCodec[RareWord] {
  ...
  override def encoder: (RareWord, TProtocol) => Unit = (r: RareWord,t:TProtocol) => encode(r,t)

  @scala.deprecated("your code is generated by an outdated version of scrooge-generator")
  override def decoder: (TProtocol) => RareWord = (t:TProtocol) => decode(t)

  override def encode(_item: RareWord, _oproto: TProtocol) { _item.write(_oproto) }
