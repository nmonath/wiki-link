...
object PageContentItem extends ThriftStructCodec[PageContentItem] {
  ...
  @scala.deprecated("your code is generated by an outdated version of scrooge-generator")
  override def encoder: (PageContentItem, TProtocol) => Unit = (p:PageContentItem,t:TProtocol) => encode(p,t)

  @scala.deprecated("your code is generated by an outdated version of scrooge-generator")
  override def decoder: (TProtocol) => PageContentItem = (t:TProtocol) => decode(t)

  override def encode(_item: PageContentItem, _oproto: TProtocol) { _item.write(_oproto) }
