...
object Context extends ThriftStructCodec[Context] {
  ...
  override def encoder: (Context, TProtocol) => Unit = (c: Context,t: TProtocol) => encode(c,t)

  @scala.deprecated("your code is generated by an outdated version of scrooge-generator")
  override def decoder: (TProtocol) => Context = (t: TProtocol) => decode(t)

  override def encode(_item: Context, _oproto: TProtocol) { _item.write(_oproto) }
