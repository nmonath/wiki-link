...
object Mention extends ThriftStructCodec[Mention] {
  ...
  override def encoder: (Mention, TProtocol) => Unit = (m: Mention, t: TProtocol) => encode(m,t)

  @scala.deprecated("your code is generated by an outdated version of scrooge-generator")
  override def decoder: (TProtocol) => Mention = (t: TProtocol) => decode(t)

  override def encode(_item: Mention, _oproto: TProtocol) { _item.write(_oproto) }
